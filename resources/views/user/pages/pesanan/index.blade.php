        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
                ...
                <div class="badge bg-danger text-light mb-2">{{ $tran->total_point }} point</div>
                @else    
                <div class="badge bg-success text-light mb-2 text-start">{{ $tran->total_point }} point</div>
               @endif
            </td>
            <td>
            ...
            <td>
              ...
              @elseif (strtolower($tran->status) == "pesanan dikirim")
              <a href="{{ route('user.pesanan.cetakInvoice', $tran->id) }}" class="btn btn-dark btn-sm text-light" type="button"><span class="material-symbols-outlined">
                print
                </span></a>
